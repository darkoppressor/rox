...
public:
    ...
    int counter_new_ball;
    int counter_end_game;

    //The player count on the last frame.
    uint32_t last_player_count;

    std::vector< std::vector<Tile> > menu_tiles;
